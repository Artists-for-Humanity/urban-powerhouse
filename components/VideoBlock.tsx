...
const VideoBlock: React.FC<VideoBlockProps> = ({
  ...
  return (
    <div className={`grid grid-cols-subgrid col-span-full ${className}`}>
      ...
      <div className="col-span-full mb-[42px] aspect-w-16 aspect-h-9 ">
        <Video className="w-full h-full overflow-hidden object-contain bg-black" src={videoFilePath} isBackground={false} />
      </div>
