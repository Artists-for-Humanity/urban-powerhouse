...
const Navigation: React.FC = () => {
    ...
    return (
    <nav className="flex justify-between items-start md:items-center md:justify-center p-4 col-span-12 w-full mt-4">
        ...
        <div className={`fixed top-0 right-0 h-full bg-(--urban-black) shadow-lg transform transition-transform duration-300 ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'} w-full z-50 md:hidden`}>
            <div className="flex justify-between items-start p-4 col-span-12 w-ful">
            <Logo size="small" />
        ...
        <nav className="hidden md:flex justify-between items-center p-4 col-span-12 w-full max-w-[1200px] max-h-[200px] overflow-hidden scale-[calc(1)]">
            <Logo size="small" />
             <Button label="Home" href="/" variant="nav" isActive={true} />
             <Button label="News" href="/" variant="nav" isActive={false} />
             <Button label="About Us" href="/" variant="nav" isActive={false} />
