...
const Footer: React.FC = () => {
    return (
        <footer className=" bottom-0 w-full bg-(--urban-blue) text-(--urban-white) py-8 col-span-6 sm:col-span-8 lg:col-span-12 sm:max-h-[400px] min-w-[98vw] overflow-hidden">
