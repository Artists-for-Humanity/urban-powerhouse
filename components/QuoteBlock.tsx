...
const QuoteBlock: React.FC<QuoteBlockProps> = ({  quote, author, authorImageSrc }) => {
  return (
    <div className="grid col-span-full grid-cols-subgrid gap-y-[32px] lg:py-10">
      ...
      <div className='col-start-1 col-span-full lg:col-start-4 lg:col-span-6  mx-[32px] lg:mx-0 lg:p-y-10 lg:flex lg:flex-col lg:justify-center'>  
        <p className="text-left text-[20px] md:text-[24px] lg:text-[32px] text-white italic font-semibold leading-none [text-edge:cap] [leading-trim:both] mt-2 mb-[24px]">{quote}</p>
        ...
        <Image
          ...
          width={240}
          height={240}
          className=" rounded-full object-cover col-start-2 col-span-4 w-full md:col-start-3 md:col-span-4 lg:col-start-10 lg:col-span-3 "
        />
    </div>
  );
};
