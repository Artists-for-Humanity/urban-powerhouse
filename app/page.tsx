...
export default function Home() {
  ...
  return (
        ...
        <div className=" mt-[40] mb-[40]!important justify-center relative items-center  font-[Poppins]  text-left mb-4 col-span-full font-semibold">
          <div className="section-1 h-[788]">
          ...
          <div className="section-3">
            ...
            <img src="/gymshots/Championship2025.jpg" alt="" className="ComunityPicture-1 grid relative min-w-[100vw] m-0 h-[282]" />
          </div>
        </div>
